    ...
    def loadClient
          ...
          def loadAgrupation
                  ...
                  Agrupacion.find_each do |obra|
                    ...
                    genero = GeneroMusical.find_by(id: obra.Id_genero) ? GeneroMusical.find_by(id: obra.Id_genero).Nombre_genero : ''
                    tipo = TipoAgrupacion.find_by(id: obra.Id_tipo_banda) ? TipoAgrupacion.find_by(id: obra.Id_tipo_banda).Nombre_tipo_banda : ''
